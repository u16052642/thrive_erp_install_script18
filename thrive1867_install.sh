...
sudo adduser --system --quiet --shell=/bin/bash --home=$OE_HOME --gecos 'THRIVE1867' --group $OE_USER
...
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/ShaheenHossain/thrive_divinlonji_18ent $OE_HOME_EXT/
